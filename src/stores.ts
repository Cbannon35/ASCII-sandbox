...
ascii_struct.set([{ ascii: [], color: '#FFFFFF' }]);

export let ascii = writable<string[][]>([[]]);
export let ascii_encoding = writable<string[][]>([[]]);
export let pointer_row = writable<number>(0);
export let pointer_char = writable<number>(0);

export let font = writable<string>('Standard');
export const fonts = [
	'1Row',
	'3-D',
	'3D Diagonal',
